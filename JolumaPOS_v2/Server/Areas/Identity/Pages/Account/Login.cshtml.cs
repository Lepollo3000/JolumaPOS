...
namespace JolumaPOS_v2.Server.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (signedUser != null && !signedUser.Lockout && signedUser.EmailConfirmed)
                {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Esta cuenta no ha sido confirmada o no existe. Contacte a un administrador.");
                    return Page();
                }
            }
