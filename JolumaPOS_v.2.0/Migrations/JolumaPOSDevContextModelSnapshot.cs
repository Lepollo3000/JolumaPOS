...
namespace JolumaPOS_v._2._0.Migrations
{
    ...
    partial class JolumaPOSDevContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Contacto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Inventario", b =>
                {
                    b.Property<int>("Caja")
                        .HasColumnType("int")
                        .HasColumnName("caja");
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioEntradaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioEntradum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioSalidaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioSalidum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "Categoria" }, "IX_Producto_CodigoBarras")
                        .IsUnique();

                    b.ToTable("Producto");
                });

            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Proveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.VContactoProveedor", b =>
                {
                    b.Property<string>("Descripcion")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.ToView("vContactoProveedor");
                });

            modelBuilder.Entity("JolumaPOS_v._2._0.Models.VProductoInventario", b =>
                {
                    b.Property<int>("Caja")
                        .HasColumnType("int")
                        .HasColumnName("caja");
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.VentaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.VentaPago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Ventum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Categorium", b =>
                {
                    b.HasOne("JolumaPOS_v._2._0.Models.Categorium", "PadreNavigation")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Contacto", b =>
                {
                    b.HasOne("JolumaPOS_v._2._0.Models.Proveedor", "ProveedorNavigation")
                        .WithMany("Contactos")
                        .HasForeignKey("Proveedor")
                        .HasConstraintName("FK_Contacto_ContactoProveedor")
                        .IsRequired();

                    b.HasOne("JolumaPOS_v._2._0.Models.ContactoTipo", "TipoContactoNavigation")
                        .WithMany("Contactos")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Inventario", b =>
                {
                    b.HasOne("JolumaPOS_v._2._0.Models.Caja", "CajaNavigation")
                        .WithMany("Inventarios")
                        .HasForeignKey("Caja")
                        .HasConstraintName("FK_Inventario_Caja")
                        .IsRequired();

                    b.HasOne("JolumaPOS_v._2._0.Models.Producto", "ProductoNavigation")
                        .WithMany("Inventarios")
                        .HasForeignKey("Producto")
                        .HasConstraintName("FK_Inventario_Producto")
                        .IsRequired();

                    b.HasOne("JolumaPOS_v._2._0.Models.TipoMonedum", "TipoMonedaCompraNavigation")
                        .WithMany("InventarioTipoMonedaCompraNavigations")
                        .HasForeignKey("TipoMonedaCompra")
                        .HasConstraintName("FK_Inventario_TipoMoneda")
                        .IsRequired();

                    b.HasOne("JolumaPOS_v._2._0.Models.TipoMonedum", "TipoMonedaVentaNavigation")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioEntradaDetalle", b =>
                {
                    b.HasOne("JolumaPOS_v._2._0.Models.InventarioEntradum", "EntradaInventarioNavigation")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioEntradum", b =>
                {
                    ...
                    b.HasOne("JolumaPOS_v._2._0.Models.InventarioStatus", "StatusNavigation")
                        .WithMany("InventarioEntrada")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.InventarioSalidaDetalle", b =>
                {
                    ...
                    b.HasOne("JolumaPOS_v._2._0.Models.InventarioSalidum", "SalidaInventarioNavigation")
                        .WithMany("InventarioSalidaDetalles")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Producto", b =>
                {
                    b.HasOne("JolumaPOS_v._2._0.Models.Categorium", "CategoriaNavigation")
                        .WithOne("Producto")
                        .HasForeignKey("JolumaPOS_v._2._0.Models.Producto", "Categoria")
                        .HasConstraintName("FK_Producto_Categoria1")
                        .IsRequired();

                    b.HasOne("JolumaPOS_v._2._0.Models.UnidadMedidum", "UnidadMedidaNavigation")
                        .WithMany("Productos")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.VentaDetalle", b =>
                {
                    ...
                    b.HasOne("JolumaPOS_v._2._0.Models.Ventum", "VentaNavigation")
                        .WithMany("VentaDetalles")
                        .HasForeignKey("Venta")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.VentaPago", b =>
                {
                    b.HasOne("JolumaPOS_v._2._0.Models.TipoPago", "TipoPagoNavigation")
                        .WithMany("VentaPagos")
            ...
            modelBuilder.Entity("JolumaPOS_v._2._0.Models.Ventum", b =>
                {
                    ...
                    b.HasOne("JolumaPOS_v._2._0.Models.Cliente", "ClienteNavigation")
                        .WithMany("Venta")
                        .HasForeignKey("Cliente")
                        .HasConstraintName("FK_Venta_Cliente")
                        .IsRequired();

                    b.HasOne("JolumaPOS_v._2._0.Models.VentaStatus", "StatusNavigation")
                        .WithMany("Venta")
                        .HasForeignKey("Status")
